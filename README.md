...
5. После накатки дампа базы из скрипта 'addressbook.sql' и разворачивания/деплоя веб-приложения на сервере приложений, в пропертях 'WEB-INF/jdbc.properties' настраивается доступ к базе данных.
